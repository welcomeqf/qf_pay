...
public class IdGenerator {
    ...
    private void initIdWorker() {
        synchronized (this) {
            if (idWorker == null) {
                ...
                log.info("IdGenerator:init success! workerId = {}, dataCenterId = {}", workerId, dataCenterId);
            }
        }
    }
    ...
    /**
     * 获取一个新的uuid
     * IdGenerator.getUuid() = b2b0f9d8d3314d2b8194dbe06e47b003
     *
     * @return
     */
    ...
    /**
     * 获取一个新的数字id（递增）
     * IdGenerator.getNumberId() = 569836297854648320
     *
     * @return
     */
    ...
    /**
     * 获取新的订单号
     * IdGenerator.getOrderCode() = 20190708151819597808694734000128
     * @return
     */
